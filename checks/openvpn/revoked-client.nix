  ...
  mkClientNode =
    ...
    { ... }:
    {
      ...
      services.pdOpenvpnClient = {
        ...
        clientCertFile = "${approvedWorkspace}/issued/openvpn/clients/${certName}/${certName}.crt";
        clientKeyFile = "${approvedWorkspace}/issued/openvpn/clients/${certName}/${certName}.key";
